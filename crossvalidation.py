...
def objective(args):
    l2_0, l2_1, smooth_0, smooth_1 = args
    # defaults
    params = {
        "method": "BFGS",
        "options": {
    ...
    #can't find files if I don't do this
    outdir = '/'.join(outdir.split("/")[:-1]) 
...
if __name__ == "__main__":
    ...
    space = [hp.lognormal('l2_0', 0, 1), hp.lognormal('l2_1', 0, 2), hp.lognormal('smooth_0', 0, 2), hp.lognormal('smooth_1', 0, 2)] 
